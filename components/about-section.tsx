...
export function AboutSection() {
  ...
  const tabs = [
    { 
      ...
      name: "Development",
      content: "I build modern applications using Flutter, React, and Next.js with a focus on performance and accessibility. My code is clean, maintainable, and follows best practices."
    },
    { 
      icon: <Globe className="h-5 w-5" />,
      name: "Experience",
      content: "With 5+ years of professional experience, I've developed solutions for startups and established businesses. Currently, I'm a Front-End Developer at DEVCIR, creating innovative applications."
    },
    { 
      icon: <Database className="h-5 w-5" />,
      name: "Skills",
      content: "My expertise includes Flutter, Dart, React, Next.js, Firebase, and REST APIs. I'm also experienced in state management, responsive design, and performance optimization."
    },
    { 
      icon: <Puzzle className="h-5 w-5" />,
      name: "Process",
      content: "I approach projects with a user-centered mindset, combining design thinking with technical solutions. I believe in iterative development and continuous improvement."
    },
  ]
