...
export function ContactSection() {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "talhayameen98@gmail.com",
      link: "mailto:talhayameen98@gmail.com",
    },
    {
      icon: <Phone className="h-6 w-6" />,
      title: "Phone",
      value: "+92 317 6442326",
      link: "tel:+923176442326",
    },
    {
  ...
  const socials = [
    {
      name: "Github",
      url: "https://github.com/Realistic-Talha",
      icon: <Github className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />,
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/realistictalha/",
      icon: <Linkedin className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />,
    },
    {
      name: "Instagram",
      url: "https://www.instagram.com/realistic.talha",
      icon: <Instagram className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />,
    },
    {
      name: "Email",
      url: "mailto:talhayameen98@gmail.com",
