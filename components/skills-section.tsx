...
const skills: Skill[] = [
  ...
  { 
    ...
    level: 92, 
    color: "#1572B6", 
    lightModeColor: "#0D4F8B", // Darker blue for light mode
    category: "frontend" 
  },
  { 
    id: "javascript", 
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center w-full mb-0 sm:mb-6 md:mb-12">
          ...
          >
            My <span className="text-gradient animate-gradient-move">Cosmic</span> Skillset
          </motion.h2>
          <motion.p
          ...
          >
            Explore my universe of technical abilities. Each star represents a technology I've mastered along my journey.
          </motion.p>
        </div>
